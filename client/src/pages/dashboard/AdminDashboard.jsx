...
const AdminDashboard = () => {
  ...
  return (
    <>
      <div className="h-[92vh] flex gap-4 m-2">
        <div className="w-64 shrink-0 bg-(--color-base-200) p-4 rounded-lg shadow-md h-full">
          <AdminSidebar activeTab={activeTab} setActiveTab={setActiveTab} />
        </div>
        <div className="flex-1 bg-(--color-base-100) p-4 rounded-lg shadow-md h-full">
